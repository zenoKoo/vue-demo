<template lang="html">
    <transition name="showAbout">
        <div class="about">
            <i @click="showAbout" class="close" :style="icons.close"></i>
            <div class="about-content">
                ...
                <div>Vue2
                    ...
                    <br>axios(发起http请求)
                    <br>SASS(SCSS)
                    <br>Express(上线版本是Koa2)
                    <br>Webpack
                    <br>Moment.js(时间处理)
                    <br>ES6
                    <br>localStorage(HTML5)
                    <br>Canvas(页面顶部小雪花)
                    <br>CSS3</div>
                ...
                <p>
                    <br>&nbsp;&nbsp;&nbsp;待业码农，求工作～～如果你觉得该项目不错，还可以请我吃辣条😄↓↓↓</p>
                <div class="help">
                    <img :src="icons.help" alt="microzz.com">
                </div>
                <p class="copyright"><b>【声明】</b>：本项目仅供学习交流使用，请不要用作任何商业用途。有任何疑问请联系作者↓
                    <br>📩：<a href="mailto:zhaohui@microzz.com">zhaohui@microzz.com</a></p>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            icons: {
                close: {
                  background: 'url('+require('../../../common/icons/close.svg')+') no-repeat',
                  backgroundSize: 'contain'
                },
                help: require('../../../common/icons/help.png')
            }
        }
    },
    computed: {
        isShowAbout() {
            return this.$store.state.cnode.isShowAbout;
        }
    },
    methods: {
        showAbout() {

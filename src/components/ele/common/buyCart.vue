    ...
    <section class="cart_module">
        <section class="cart_button" v-if="!foods.specifications.length">
            <transition name="showReduce">
                <span @click="removeOutCart(foods.category_id, foods.item_id, foods.specfoods[0].food_id, foods.specsfoods[0].name,foods.specsfoods[0].price, '', foods.specsfoods[0].packing_fee, foods.specsfoods[0].sku_id, foods.specsfoods[0].stock)" v-if="foodNum">
                    <svg>
                        <use xmlns:href="@cart-minus" xmlns:xlink="http://www.w3.org/1999/xlink"></use>
                    </svg>
                </span>
            </transition>
        ...
        <section v-else class="choose_specification">
            <section class="choose_icon_container">
                ...
                <transition name="fade">
                    <span v-if="foodNum" class="cart_num">{{foodNum}}</span>
                </transition>

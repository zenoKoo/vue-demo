        ...
        <div v-else>
            ...
            <section class="msg-movie">
                ...
                <div>
                    ...
                    <p v-for="item in movieMsg.durations" v-if="item.indexOf('中国')>-1">{{item}}</p>
                    <p v-for="item in movieMsg.pubdates" v-if="item.indexOf('中国')>-1">{{item}}</p>
                </div>
            </section>
            ...
            <section class="msg-scoll-hidden">
                <section class="msg-star-wrap">
                    <h3 class="msg-star-first-title">演职人员</h3>
                    <div class="msg-scoll">
...
export default {
    data() {
        ...
        mounted() {
            const url = '/movie/subject/' + this.$route.params.id + '?apikey=0b2bdeda43b5688921839c8ecb20399b&city=%E5%8C%97%E4%BA%AC&client=&udid='
            this.$http.get(url).then(response => {
                this.movieMsg = response.body
